...
/* THESIS: The portfolio opens inside the symbol, not beside it — one
   ...
   split text/illustration hero. There is no chrome over it: the page carries
   no header, so the first screen is the photograph and nothing else.
   ...
   focus. Clash Display for voice, Satoshi for body.
